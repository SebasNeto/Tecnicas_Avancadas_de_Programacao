...
/**
 * A classe RelatorioCargos representa a tela de exibição do relatório de salarios de funcionarios.
 */
...
public class RelatorioSalarios extends JPanel{
    ...
    /**
     * Cria uma nova instância da classe RelatorioSalarios.
     */
    ...
    private void criarComponentes(){
        ...
        labelDescricao = new JLabel("Esse grafico representa a quantidade de funcionarios por faixas salariais.", JLabel.CENTER);
        
        CategoryDataset dadosGrafico = this.criarDadosGrafico();
        
        JFreeChart someChart = ChartFactory.createBarChart("", null, "Quantidade de funcionarios", dadosGrafico, PlotOrientation.VERTICAL, true, true, false);
     ...
     private CategoryDataset criarDadosGrafico(){
         ...
         try{
             ...
             JOptionPane.showMessageDialog(null, "Ocorreu um erro criar o relatorio.\n\n"+ex.getMessage());
                Navegador.inicio();
         }
         return null;
     }
