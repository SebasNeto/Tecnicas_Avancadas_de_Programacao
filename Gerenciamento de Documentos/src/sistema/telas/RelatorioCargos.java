...
/**
 * A classe RelatorioCargos representa a tela de exibição do relatório de cargos.
 */
...
public class RelatorioCargos extends JPanel{
    ...
    /**
     * Cria uma nova instância da classe RelatorioCargos.
     */
    ...
    private void criarComponentes(){
        ...
        labelDescricao = new JLabel("Esse grafico representa a quantidade de funcionarios por cargos", JLabel.CENTER);
    ...
    private DefaultPieDataset criarDadosGrafico(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Ocorreu um erro ao criar relatorio. \n\n"+ex.getMessage());
            Navegador.inicio();
        }
